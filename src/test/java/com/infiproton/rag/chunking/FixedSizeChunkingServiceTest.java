...
public class FixedSizeChunkingServiceTest {

    @Autowired
    private FixedSizeChunkingService fixedSizeChunkingService;
    ...
    void shouldChunkPdfDocument() {
        ...
        List<KnowledgeChunk> chunks = fixedSizeChunkingService.chunkDocument(document);
